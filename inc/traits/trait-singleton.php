...
namespace Doppio_Coffee\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the `doppio_coffee_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf( 'doppio_coffee_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores, WordPress.NamingConventions.PrefixAllGlobals.DynamicHooknameFound
